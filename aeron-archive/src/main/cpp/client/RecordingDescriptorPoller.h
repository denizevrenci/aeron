#ifndef AERON_ARCHIVE_RECORDINGDESCRIPTORPOLLER_H
#define AERON_ARCHIVE_RECORDINGDESCRIPTORPOLLER_H
...
#include "RecordingDescriptorConsumer.h"
...
public:
    ...
    /**
     * Get the expected number of remaining records.
     *
     * @return the expected number of remaining records.
     */
...
private:
    ...
    std::int32_t m_remainingRecordCount;
    bool m_isDispatchComplete = false;
    on_recording_descriptor_t m_consumer;
...
#endif // AERON_ARCHIVE_RECORDINGDESCRIPTORPOLLER_H
